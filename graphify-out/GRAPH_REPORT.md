...
- **Source-First Workspace Publication** — agents_monorepo_workspaces, agents_source_first_publish_workflow, developer_guide_local_development [INFERRED 0.80]
- **Extension MCP Browser Control Flow** — mcp_mcp_server, mcp_launcher_page, mcp_websocket_hub, readme_chrome_extension [EXTRACTED 1.00]
- **DOM to LLM Action Loop** — graph_report_agents_dom_pipeline, graph_report_agents_page_controller_package, graph_report_agents_llms_package, graph_report_core_prompt_indexed_interactions [EXTRACTED 1.00]
- **Extension MCP Browser Control Flow** — graph_report_mcp_mcp_server, graph_report_mcp_launcher_page, graph_report_mcp_websocket_hub, graph_report_readme_chrome_extension [EXTRACTED 1.00]
- **Source-First Workspace Publication** — graph_report_agents_monorepo_workspaces, graph_report_agents_source_first_publish_workflow, graph_report_developer_guide_local_development [INFERRED 0.80]
